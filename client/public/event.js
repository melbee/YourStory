...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fetch_vis_data = __webpack_require__(109);

	var _fetch_vis_data2 = _interopRequireDefault(_fetch_vis_data);
	...
	var aliases = {
	  ...
	  'user-clicked-alias': function userClickedAlias() {
	    ...
	    chrome.identity.getAuthToken({
	      ...
	      x.onload = function () {
	        var userInfo = JSON.parse(x.response);
	...
	var createStoreWithMiddleware = (0, _redux.applyMiddleware)(_reduxThunk2.default, (0, _reactChromeRedux.alias)(aliases))(_redux.createStore);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _wrapStore = __webpack_require__(70);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _chrome_id = __webpack_require__(107);

	var _chrome_id2 = _interopRequireDefault(_chrome_id);
...
/***/ function(module, exports) {
	...
	exports.default = function () {
	  ...
	  switch (action.type) {
	    case 'FETCH_TOKEN':
	      return _extends({}, state, { chromeID: action.payload });
	    default:
	      return state;
	  }
	};
...
/***/ function(module, exports) {
	...
	// export default function loadTokenOnResponse (data) {
	//   return {
	//     type: 'FETCH_TOKEN',
	//     payload: data, //token
	//   };
	...
	//using fetchToken code in store.js
	//  function fetchToken() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var btoa = (typeof window !== 'undefined' && window.btoa) || __webpack_require__(124);
